...
class Penjelasan : AppCompatActivity() {
    ...
    val detail =
        "\tMonty hall problem adalah permasalah yang berasal dari acara televisi yaitu let's make a deal pada tahun 1963. Pada acara let's make a deal pembawa acara menunjukan 3 pintu kepada kontestan dimana dari salah satu pintu terdapat hadiah yaitu sebuah mobil dan sisanya adalah kambing, pembawa acara meminta kontestan memilih salah 1 dari 3 pintu, setelah itu pembawa acara membuka salah 1 pintu yang didalamnya tedapat kambing. Setelah pintu yang terdapat kambing dibuka pembawa acara akan menanyakan kepada konsestan apakah konsetan akan mengganti pintu pilihanya dia. Disinilah dimulainya monty hall problem,Pada dasaranya jika pada saat keadaan yang tersebut seseorang lebih memilih tetap pada pintu yang dia pilih pada awalnya karena kemungkinanmemenangkan sebuah mobil menjadi 50:50. Padahal kemungkinan sosorang mendapat mobil dengan mengganti pintunya lebih tinggi dibanding tidak mengganti pilihannya. Berikut beberapa penjelasannya:\n" +
    ...
    lateinit var detil_penjelasan:TextView
    lateinit var back_penjelasan:ImageButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detil_penjelasan=findViewById(R.id.detil_monty)
        back_penjelasan=findViewById(R.id.back_penjelasan)

        detil_penjelasan.text=detail
        back_penjelasan.setOnClickListener {
